...
PACKAGE=qgis_atlasprint
FILES = ../filters ../i18n ../scripts ../*.py ../*.qrc ../*.ui ../icon.png ../metadata.txt ../README.md
...
package: build2/atlasprint
	@echo "Building package qgis_atlasprint"
	@cp -rLp $(FILES) build2/atlasprint/
	$(FABRIC) package:qgis_atlasprint,versiontag=$(VERSION),files=atlasprint,directory=./build2
